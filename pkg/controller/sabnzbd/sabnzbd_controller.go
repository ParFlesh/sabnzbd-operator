...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner SABnzbd
...
// Reconcile reads that state of the cluster for a SABnzbd object and makes changes based on the state read
// and what is in the SABnzbd.Spec
...
func (r *ReconcileSABnzbd) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set SABnzbd instance as the owner and controller
...
func newPodForCR(cr *sabnzbdv1alpha1.SABnzbd) *corev1.Pod {
